                ...
                if ($stmt_etiquetas) {
                    ...
                    while ($row_etq = $res_etiquetas->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="etiquetas.php?editar=<?= $row_etq['id_etiqueta'] ?>"
                                    class="btn btn-warning btn-sm">
                                    Editar
                                </a>
                                <a href="guardar_etiqueta.php?eliminar=<?= $row_etq['id_etiqueta'] ?>"
...
<script>
    ...
    // Capturar clic en los enlaces "Eliminar"
    ...
    // Confirmar eliminación → ir al enlace original
